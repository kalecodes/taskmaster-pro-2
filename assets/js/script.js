...
// function to audit task dates and conditionally style element
var auditTask = function(taskEl) {
  ...
  // apply new class if task is near/past due date
...
$(".card .list-group").sortable({
  ...
  update: function(event) {
    ...
    var tempArr = [];
    // loop over current children in sortable list
...
// click event for editing task description
...
// click event for saving edited task description
$(".list-group").on("blur", "textarea", function() {
  ...
  // update 'tasks' object with new data
...
// click event for editing task date
...
// click event for saving edited task date
